...
hi Typedef                     guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=216   ctermbg=254   cterm=NONE
...
hi PreCondit                   guifg=#8922ce        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
hi Include                     guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
hi Float                       guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=254   cterm=NONE
...
hi Identifier                  guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=254   cterm=NONE
...
hi StorageClass                guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=1     ctermbg=254   cterm=NONE
hi Todo                        guifg=#bbbb87        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=144   ctermbg=254   cterm=NONE
hi Special                     guifg=#8922ce        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
...
hi Delimiter                   guifg=#e0c07e        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=254   cterm=NONE
...
hi Number                      guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=254   cterm=NONE
hi Boolean                     guifg=#7ec0ee        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=117   ctermbg=254   cterm=NONE
hi Operator                    guifg=s:red          guibg=s:background  guisp=s:background  gui=italic  ctermfg=1     ctermbg=254   cterm=NONE
...
hi ModeMsg                     guifg=#d0d0d0        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
hi Define                      guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
...
hi PreProc                     guifg=#8922ce        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
...
hi Exception                   guifg=s:red          guibg=s:background  guisp=s:background  gui=NONE    ctermfg=216   ctermbg=254   cterm=NONE
hi Keyword                     guifg=s:red          guibg=s:background  guisp=s:background  gui=NONE    ctermfg=1     ctermbg=254   cterm=NONE
hi Type                        guifg=s:magenta      guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE
...
hi Structure                   guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=1     ctermbg=254   cterm=NONE
hi Macro                       guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=254   cterm=NONE

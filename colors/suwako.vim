...
hi Include                     guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=92    ctermbg=254   cterm=NONE
...
hi Delimiter                   guifg=#e0c07e        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=28    ctermbg=254   cterm=NONE
...
hi ModeMsg                     guifg=#d0d0d0        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=92    ctermbg=254   cterm=NONE
hi Define                      guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=92    ctermbg=254   cterm=NONE
...
hi Type                        guifg=s:magenta      guibg=s:background  guisp=s:background  gui=NONE    ctermfg=92    ctermbg=254   cterm=NONE
...
hi Macro                       guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=92    ctermbg=254   cterm=NONE

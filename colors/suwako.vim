...
hi StorageClass                guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5     ctermbg=NONE   cterm=NONE
...
hi Character                   guifg=#8fe779        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=2   ctermbg=NONE   cterm=NONE

...
hi Typedef                     guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=216   ctermbg=NONE   cterm=NONE
...
hi PreCondit                   guifg=#8922ce        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=NONE   cterm=NONE
hi Include                     guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=NONE   cterm=NONE
hi Float                       guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=NONE   cterm=NONE
...
hi Identifier                  guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=NONE   cterm=NONE
...
hi StorageClass                guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=1     ctermbg=NONE   cterm=NONE
...
hi Label                       guifg=s:red          guibg=s:background  guisp=s:background  gui=NONE    ctermfg=216   ctermbg=NONE   cterm=NONE
...
hi Delimiter                   guifg=#e0c07e        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=NONE   cterm=NONE
hi Statement                   guifg=s:yellow       guibg=s:background  guisp=s:background  gui=bold    ctermfg=3     ctermbg=NONE   cterm=bold
hi Comment                     guifg=#406b6b        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=66    ctermbg=NONE   cterm=NONE
hi Character                   guifg=#8fe779        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=156   ctermbg=NONE   cterm=NONE
hi Number                      guifg=s:green        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=10    ctermbg=NONE   cterm=NONE
hi Boolean                     guifg=#7ec0ee        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=1NONE   ctermbg=NONE   cterm=NONE
hi Operator                    guifg=s:red          guibg=s:background  guisp=s:background  gui=italic  ctermfg=1     ctermbg=NONE   cterm=NONE
...
hi Define                      guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=NONE   cterm=NONE
...
hi MoreMsg                     guifg=#d0d097        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=187   ctermbg=NONE   cterm=NONE
hi VertSplit                   guifg=#000000        guibg=#878787       guisp=#878787       gui=NONE    ctermfg=NONE  ctermbg=102   cterm=NONE
hi Exception                   guifg=s:red          guibg=s:background  guisp=s:background  gui=NONE    ctermfg=216   ctermbg=NONE   cterm=NONE
hi Keyword                     guifg=s:red          guibg=s:background  guisp=s:background  gui=NONE    ctermfg=1     ctermbg=NONE   cterm=NONE
hi Type                        guifg=s:magenta      guibg=s:background  guisp=s:background  gui=NONE    ctermfg=5    ctermbg=NONE   cterm=NONE
...
hi Constant                    guifg=s:lightcyan    guibg=s:background  guisp=s:background  gui=NONE    ctermfg=30    ctermbg=NONE   cterm=NONE
hi Tag                         guifg=#e0c07e        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=180   ctermbg=NONE   cterm=NONE
hi String                      guifg=#7c9913        guibg=s:background  guisp=s:background  gui=NONE    ctermfg=64    ctermbg=NONE   cterm=NONE
...
hi Structure                   guifg=s:red          guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=1     ctermbg=NONE   cterm=NONE
hi Macro                       guifg=s:magenta      guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=5    ctermbg=NONE   cterm=NONE
hi Underlined                  guifg=#1e90ff        guibg=s:background  guisp=#1b1b1b       gui=NONE    ctermfg=33    ctermbg=NONE   cterm=NONE
